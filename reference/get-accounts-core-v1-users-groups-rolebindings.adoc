...
summary: Auflisten der Rollenbindungen für eine mit einem Benutzer verbundene Gruppe 
---
= Auflisten der Rollenbindungen für eine mit einem Benutzer verbundene Gruppe
:allow-uri-read: 
