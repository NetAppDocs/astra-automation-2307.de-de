...
summary: Abrufen eines Anwendungs-Assets für einen Anwendungs-Snapshot und eine App 
---
= Abrufen eines Anwendungs-Assets für einen Anwendungs-Snapshot und eine App
:allow-uri-read: 
