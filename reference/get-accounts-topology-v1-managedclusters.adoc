...
| Elemente | array[Beliebig aus: link:#managedCluster_1_2_get_response_body["managedCluster_1.2_get_response_body"], array[]] | True  a| 
...
| managedTimestamp | Zeichenkette | True  a| 
...
| clusterVersion | Zeichenkette | True  a| 
...
| clusterVersionString | Zeichenkette | True  a| 
...
| isMultizonal | Zeichenkette | True  a| 
