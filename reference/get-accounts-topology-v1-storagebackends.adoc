...
| Elemente | array[Beliebig aus: link:#storageBackend_1_3_get_response_body["storageBackend_1.3_get_response_body"], array[]] | True  a| 
...
| authenticationStyle | Zeichenkette | True  a| 
...
| backendName | Zeichenkette | True  a| 
...
| backendType | Zeichenkette | True  a| 
...
| backendVersion | Zeichenkette | True  a| 
...
| backendCredentialsName | Zeichenkette | True  a| 
...
| Fähigkeiten | link:#capabilities["Fähigkeiten"] | True  a| 
JSON-Objekt, das die Funktionen dieses Storage Backend enthält.
