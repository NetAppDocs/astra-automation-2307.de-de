...
summary: Alle Clouds auflisten 
---
= Alle Clouds auflisten
:allow-uri-read: 
...
| Elemente | array[Beliebig aus: link:#cloud_1_1_get_response_body["cloud_1.1_get_response_body"], array[]] | True  a| 
...
* „discovering“ – Die Cloud wird gerade entdeckt
...
| defaultBucketID | Zeichenkette | Falsch  a| 
