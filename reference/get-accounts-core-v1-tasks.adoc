...
| Elemente | array[Beliebig aus: link:#task_1_1_get_response_body["task_1.1_get_response_body"], array[]] | True  a| 
...
| resourceURI | Zeichenkette | True  a| 
...
| stateTransitions | Array[link:#type_astra_stateTransition["type_astra_stateTransition"]] | True  a| 
