...
| Elemente | array[Beliebig aus: link:#certificate_1_1_get_response_body["certificate_1.1_get_response_body"], array[]] | True  a| 
...
| Zertifikat | Zeichenkette | True  a| 
...
| expiryTimestamp | Zeichenkette | True  a| 
...
| isSelfSigned | Zeichenkette | True  a| 
...
* Wird kein Wert angegeben und das Feld „cert“ nicht in die Aktualisierung einbezogen, bleibt der bestehende Wert erhalten. Folgende Werte sind definiert:
...
| trustState | Zeichenkette | True  a| 
...
| trustStateTransitions | Array[link:#type_astra_stateTransition["type_astra_stateTransition"]] | True  a| 
...
| trustStateDetails | Array[link:#type_astra_stateDetail["type_astra_stateDetail"]] | True  a| 
