...
summary: Token für einen Benutzer auflisten 
---
= Token für einen Benutzer auflisten
:allow-uri-read: 
...
| Elemente | array[Beliebig aus: link:#token_1_0_get_response_body["token_1.0_get_response_body"], array[]] | True  a| 
...
| Name | Zeichenkette | True  a| 
JSON-Zeichenkette mit einem Token-Namen. Folgende Werte sind definiert:
