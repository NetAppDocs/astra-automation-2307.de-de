...
| Elemente | array[Beliebig aus: link:#clusterNode_1_0_get_response_body["clusterNode_1.0_get_response_body"], array[]] | True  a| 
...
| creationTime | Zeichenkette | True  a| 
...
| externalIP | Zeichenkette | True  a| 
...
| internalIP | Zeichenkette | True  a| 
...
| instanceType | Zeichenkette | True  a| 
...
| kernelVersion | Zeichenkette | True  a| 
