...
| Elemente | array[Beliebig aus: link:#event_1_4_get_response_body["event_1.4_get_response_body"], array[]] | True  a| 
...
| Zusammenfassung | Zeichenkette | True  a| 
...
| Ressourcen-ID | Zeichenkette | True  a| 
...
| resourceType | Zeichenkette | True  a| 
...
| Korrelations-ID | Zeichenkette | True  a| 
...
| description | Zeichenkette | True  a| 
...
JSON-Array von JSON-Strings, die jeweils ein zusätzliches Ziel für das Ereignis angeben. Diese Strings ermöglichen es einem Service, Hinweise darüber zu geben, wohin ein Ereignis zusätzlich zum Aktivitätsprotokoll weitergeleitet werden soll. Optional. Folgende Werte sind definiert:
